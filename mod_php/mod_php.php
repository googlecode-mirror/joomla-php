<?php
/*
* mod_php allows inclusion of HTML/JS/CSS and now PHP, in Joomla/Mambo Modules
	...
	*/
	class modHTML {
		...
		*/
		...
		/**
		* Parse PHP using eval()
		*/
		function parsePHPviaEval($php) {
			eval("\r\n?>\r\n ".$php."\r\n<?php\r\n");
		}
